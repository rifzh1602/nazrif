...
Saya Sudah Mengisi Form Dan Membuat Kode QR Dan Akan Di Scan Di Acara Pernikahan Arif & Nazah.`;
      ...
      {!submitted ? (
        ...
        >
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-gray-400 font-bold">16 September 2026</p>
          </div>
